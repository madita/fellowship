export default {
    ...
    'admin': {
        ...
        'forums': {
            ...
            'addSubForum': 'Unterforum hinzufügen',
            'name': 'Forenname',
            'description': 'Beschreibung',
            'parentForum': 'Übergeordnetes Forum',
            'position': 'Position',
            'isPrivate': 'Privat (nur Admins)',
            'isLocked': 'Gesperrt (keine neuen Themen)',
            'noForums': 'Noch keine Foren',
            'noForumsDescription': 'Erstelle deine erste Forenkategorie, um loszulegen.',
            'createFirst': 'Erstes Forum erstellen',
    ...
    'gallery': {
        'title': 'Galerie',
        'noCollections': 'Noch keine Alben',
        'noCollectionsText': 'Es gibt derzeit keine Fotoalben. Alben erscheinen hier, sobald sie erstellt wurden.',
        'noImages': 'Noch keine Bilder in diesem Album',
        'noImagesText': 'Lade über den Plus-Button oben das erste Bild hoch.',
        'viewAll': 'Alle anzeigen',
    ...
    'timeline': {
        ...
        'noStatusYet': 'Noch keine Statusmeldungen',
    ...
    'migrationTool': {
        ...
        'noSources': 'Noch keine Datenquellen. Füge die Datenbank hinzu, aus der importiert werden soll.',
        'driver': 'Treiber',
        'database': 'Datenbank',
        ...
        'testConnection': 'Verbindung testen',
        'connectionOk': 'Verbindung OK — {tables} Tabellen gefunden',
        'connectionFailed': 'Verbindung fehlgeschlagen: {error}',
        'sourceSaved': 'Quelle gespeichert',
        'confirmDeleteSource': 'Quelle "{name}" löschen? Ihre Mappings werden ebenfalls entfernt.',
        'mappings': 'Mappings',
        'addMapping': 'Mapping hinzufügen',
        'editMapping': 'Mapping bearbeiten',
        'noMappings': 'Noch keine Mappings. Ein Mapping verbindet eine Quelltabelle mit einem Feature.',
        'mappingFlow': 'Tabelle → Ziel',
        'source': 'Quelle',
        'target': 'Ziel-Feature',
        'sourceTable': 'Quelltabelle',
        'rowsInTable': '{count} Zeilen in dieser Tabelle',
        'fieldMapping': 'Feld-Mapping',
        ...
        'sample': 'Beispiel',
        'preview': 'Vorschau',
        'previewTitle': 'Vorschau (erste Zeilen von {total})',
        'issues': 'Probleme',
        'mappingSaved': 'Mapping gespeichert',
        ...
        'joinsHint': 'Verknüpfe verwandte Tabellen, um auch deren Spalten zu mappen — z. B. MediaWiki: „revision" über revision.rev_id = page.page_latest, dann „text" über text.old_id = revision.rev_text_id.',
        'joinType': 'Typ',
        'joinTable': 'Tabelle',
        'joinFirst': 'Join-Spalte',
        'joinSecond': 'Gleich Spalte',
        'filters': 'Zeilenfilter',
        'addFilter': 'Filter hinzufügen',
        'filtersHint': 'Nur Zeilen, die allen Filtern entsprechen, werden importiert — z. B. page_namespace = 0 für MediaWiki-Inhaltsseiten.',
        'filterColumn': 'Spalte',
        'filterValue': 'Wert',
        'template': 'Vorlage',
        ...
        'forumArchiveCategory': 'Name der Archiv-Kategorie',
        'forumArchiveLock': 'Importierte Themen sperren (nur lesbar)',
    ...
    'achievements': {
        ...
        'metrics': {
                'forum.thread.created': 'Thema im Forum eröffnet',
                'forum.post.created': 'Im Forum geantwortet',
                'forum.post.solution': 'Eine Antwort wurde als hilfreich markiert',
                'forum.post.liked': 'Eine Antwort wurde gelikt',
                'wiki.page.created': 'Wiki-Seite geschrieben',
                'wiki.page.approved': 'Eine Wiki-Seite wurde freigegeben',
                'wiki.page.edited': 'Wiki-Seite bearbeitet',
                'ticket.created': 'Ticket erstellt',
                'feedback.bug': 'Fehler gemeldet',
                'feedback.feature': 'Feature vorgeschlagen',
                'ticket.comment': 'Ticket kommentiert',
                'ticket.resolved': 'Ein Ticket wurde gelöst',
                'event.organised': 'Event organisiert',
                'event.joined': 'An einem Event teilgenommen',
                'timeline.post.created': 'Auf der Timeline gepostet',
                'timeline.comment': 'Timeline kommentiert',
                'poll.voted': 'An einer Umfrage teilgenommen'
        },
        'widget': {
            'subtitle': '{count} erreicht',
            'nothingYet': 'Mach mit, dann kommen sie von allein.'
        },
        'profile': {
            'title': 'Erfolge',
            'none': 'Noch keine Erfolge'
        },
        'admin': {
            'title': 'Erfolge',
            'description': 'Was Mitglieder erreichen können — und das Vergeben dessen, was die Seite nicht sieht',
            'list': 'Erfolge',
            'stats': 'Wie es läuft',
            'hint': 'Ein Erfolg beobachtet eine Aktion, die die Seite zählt — oder wird von Hand vergeben.',
            'add': 'Neuer Erfolg',
            'edit': 'Erfolg bearbeiten',
            'empty': 'Noch keine Erfolge',
            'award': 'Vergeben',
            'awardTitle': '{name} vergeben',
            'awardTo': 'Mitglied',
            'awardNote': 'Notiz',
            'awardNoteHint': 'Wofür es vergeben wurde — wird dem Mitglied gezeigt.',
            'searchMembers': 'Mindestens zwei Buchstaben eingeben',
            'currentHolders': 'Haben ihn bereits',
            'topMembers': 'Meiste Punkte',
            'unearned': 'Diese hat noch niemand erreicht: {list}',
            'unknownMetric': 'Unbekannte Aktion',
            'saved': 'Der Erfolg wurde gespeichert',
            'saveFailed': 'Der Erfolg konnte nicht gespeichert werden',
            'loadFailed': 'Die Erfolge konnten nicht geladen werden',
            'deleteTitle': 'Erfolg löschen',
            ...
            'form': {
                ...
                'description': 'Beschreibung',
                'icon': 'Icon',
                'iconUnused': 'Wird nicht genutzt, solange ein Bild gesetzt ist',
                'badgeImage': 'Bild für das Abzeichen',
                'badgeImageHint': 'PNG, JPG, GIF, WEBP oder SVG, bis 2 MB. Ersetzt das Icon.',
                ...
                'byHandHint': 'Die Seite kann das nicht sehen — jemand muss bestätigen, dass es passiert ist.',
                'action': 'Aktion',
                'count': 'Wie oft',
                'onlyFor': 'Nur diese Arten zählen',
                'onlyForHint': 'Leer lassen, um alle Arten zu zählen. Nicht jedes Event ist gleich viel Arbeit.',
                'enabled': 'Mitglieder können ihn erreichen',
                'secret': 'Geheim',
                'secretHint': 'Bleibt verborgen, bis er erreicht ist.'
            }
        }
    },
    'irc': {
    ...
    'feedback': {
        ...
        'cancel': 'Abbrechen',
        'editor': {
            'subtitle': 'Dein Eintrag ist öffentlich: andere können abstimmen, beobachten und kommentieren',
            'content': 'Dein Feedback',
            'typeHint': {
                'bug': 'Etwas funktioniert nicht wie es soll',
                'feature': 'Eine Idee, die Seite besser zu machen',
            },
            'titlePlaceholder': {
                'bug': 'z. B. Der Galerie-Upload bleibt bei 50 % stehen',
                'feature': 'z. B. Dunkelmodus für das Wiki',
            },
            'tipsTitle': 'Tipps für gutes Feedback',
            'tips': {
                'bug1': 'Beschreibe die Schritte, die zum Problem führen',
                'bug2': 'Schreib, was du erwartet hast und was stattdessen passiert ist',
                'bug3': 'Nenne Seite, Browser oder Gerät, wenn es eine Rolle spielt',
                'feature1': 'Erkläre, welches Problem die Idee lösen würde',
                'feature2': 'Beschreibe, wie es für Mitglieder funktionieren könnte',
                'feature3': 'Such zuerst: eine Stimme für einen bestehenden Wunsch zählt mehr',
            },
            'leaveTitle': 'Feedback verwerfen?',
            'leaveMessage': 'Was du bisher geschrieben hast, geht verloren.',
            'leave': 'Verwerfen',
        },
        'moderation': {
            'title': 'Moderation',
    ...
    'tickets': {
        'nav': {
            'title': 'Tickets',
            'show': 'Ticketliste einblenden',
            'hide': 'Ticketliste ausblenden',
            'loadMore': 'Mehr laden',
            'retry': 'Erneut versuchen',
        },
        'title': 'Tickets',
        ...
        'overview': {
            'title': 'Übersicht',
            'refresh': 'Aktualisieren',
            'loadFailed': 'Die Ticket-Statistiken konnten nicht geladen werden.',
            'showInList': 'In der Liste anzeigen: {label}',
            'stats': {
                'open': 'Offen',
                'unassigned': 'Nicht zugewiesen',
                'overdue': 'Überfällig',
                'urgent': 'Dringend',
                'created_7d': 'Erstellt, letzte 7 Tage',
                'resolved_7d': 'Gelöst, letzte 7 Tage'
            },
            'previousWeek': '{count} in den 7 Tagen davor',
            'avgResolution': 'Durchschnittliche Lösungszeit, letzte {days} Tage',
            'lessThanHour': 'unter 1 Std.',
            'hours': '{count} Std.',
            'days': '{count} Tage',
            'byStatus': 'Alle Tickets nach Status',
            'byType': 'Offen nach Art',
            'byPriority': 'Offen nach Priorität',
            'byAssignee': 'Offen nach Bearbeiter',
            'attention': 'Braucht Aufmerksamkeit',
            'attentionEmpty': 'Nichts überfällig oder mit hoher Priorität',
            'overdue': 'Überfällig',
            'topFeedback': 'Meistgewünschtes offenes Feedback',
            'topFeedbackEmpty': 'Noch keine Stimmen für offenes Feedback',
            'viewPublic': 'Öffentliche Feedback-Seite öffnen',
            'trend': {
                'title': 'Erstellt und gelöst, letzte {days} Tage',
                'created': 'Erstellt',
                'resolved': 'Gelöst',
                'day': 'Tag',
                'chartView': 'Diagramm',
                'tableView': 'Tabelle',
                'aria': '{created} Tickets erstellt und {resolved} gelöst in den letzten {days} Tagen',
                'keyboardHint': 'Tageswerte: mit den Pfeiltasten links und rechts zwischen den Tagen wechseln'
            }
        },
        ...
        'filters': {
            ...
            'link': {
                'mine_1': 'Von mir erstellt oder mir zugewiesen',
                'created_by_me': 'Von mir erstellt',
                'due_overdue': 'Überfällig',
                'due_week': 'Fällig in 7 Tagen',
            },
        },
        'fields': {
            'type': 'Typ',
        ...
        'editor': {
            ...
            'createSubtitle': 'Beschreibe die Anfrage; mit @ erwähnst du ein Mitglied',
            'save': 'Änderungen speichern',
            'content': 'Ticket',
            'titlePlaceholder': 'Eine kurze Zusammenfassung der Anfrage',
            'descriptionPlaceholder': 'Worum geht es, was soll als Nächstes passieren?',
            'saveHint': 'Strg + Enter speichert',
            'classification': 'Einordnung',
            'assignment': 'Zuweisung',
            'leaveTitle': 'Änderungen verwerfen?',
            'leaveMessage': 'Das Ticket hat Änderungen, die noch nicht gespeichert sind.',
            'leave': 'Verwerfen',
        },
        'detail': {
            ...
            'overdue': 'Überfällig',
            'noDescription': 'Keine Beschreibung',
            'notFound': 'Dieses Ticket existiert nicht oder ist für dich nicht sichtbar.',
            'publicPage': 'Öffentliche Seite',
            'commentsTab': 'Kommentare ({count})',
            'historyTab': 'Verlauf',
            'addComment': 'Kommentar schreiben',
            'internalNote': 'Interne Notiz (nur Admins)',
            'addNote': 'Notiz speichern',
            'addNotePlaceholder': 'Interne Notiz, nur für Admins sichtbar',
        ...
        'history': {
            'actions': {
                'created': 'hat das Ticket erstellt',
                'commented': 'hat kommentiert',
                'updated': 'hat Änderungen vorgenommen',
                'deleted': 'hat das Ticket gelöscht',
                'restored': 'hat das Ticket wiederhergestellt',
            },
            'fields': {
                'public': 'Sichtbarkeit',
            ...
            'descriptionChanges': 'Änderungen an der Beschreibung',
            'before': 'Vorher',
            'after': 'Nachher',
        ...
        'related': {
            'title': 'Verknüpfter Inhalt',
            'preview': 'Vorschau',
            'open': 'Seite öffnen',
            'empty': 'Keine Vorschau verfügbar',
            'loadFailed': 'Der Inhalt konnte nicht geladen werden.',
            'kinds': {
                'wiki': 'Wiki-Seite',
                'page': 'Seite',
            },
    ...
    'forum': {
        'title': 'Forum',
        'subtitle': 'Diskutiere mit deiner Community',
        'home': 'Startseite',
        'forums': 'Foren',
        'threads': 'Themen',
        'posts': 'Beiträge',
        ...
        'threadTitlePlaceholder': 'Gib einen aussagekräftigen Titel ein...',
        'threadBody': 'Inhalt',
        'threadBodyPlaceholder': 'Schreibe deinen Beitrag...',
        ...
        'private': 'Privat',
        'solution': 'Hilfreich',
        'markAsSolution': 'Als hilfreich markieren',
        'unmarkSolution': 'Hilfreich aufheben',
        ...
        'on': 'am',
        'ago': 'vor',
        'noForums': 'Keine Foren verfügbar',
        'noForumsDescription': 'Es gibt noch keine Forenkategorien.',
        'noThreads': 'Noch keine Themen',
        'noThreadsDescription': 'Starte als Erster eine Diskussion in diesem Forum.',
        'noPosts': 'Noch keine Antworten',
        'noPostsDescription': 'Sei der Erste, der auf dieses Thema antwortet.',
        'subForums': 'Unterforen',
        'threadCount': '{count} Thema | {count} Themen',
        'postCount': '{count} Beitrag | {count} Beiträge',
        'replyCount': '{count} Antwort | {count} Antworten',
        'viewCount': '{count} Aufruf | {count} Aufrufe',
        'loading': 'Laden...',
        'loadingForums': 'Foren werden geladen...',
        'loadingThreads': 'Themen werden geladen...',
        'loadingThread': 'Thema wird geladen...',
        'creating': 'Thema wird erstellt...',
        'submitting': 'Wird gesendet...',
        'threadCreated': 'Thema erfolgreich erstellt',
        'threadUpdated': 'Thema erfolgreich aktualisiert',
        'threadDeleted': 'Thema erfolgreich gelöscht',
        'postCreated': 'Antwort erfolgreich gepostet',
        'postUpdated': 'Beitrag erfolgreich aktualisiert',
        'postDeleted': 'Beitrag erfolgreich gelöscht',
        'markedAsSolution': 'Beitrag als hilfreich markiert',
        'confirmDeleteThread': 'Bist du sicher, dass du dieses Thema löschen möchtest? Diese Aktion kann nicht rückgängig gemacht werden.',
        ...
        'errorLoading': 'Daten konnten nicht geladen werden. Bitte versuche es erneut.',
        'errorCreating': 'Thema konnte nicht erstellt werden. Bitte versuche es erneut.',
        'errorSubmitting': 'Senden fehlgeschlagen. Bitte versuche es erneut.',
        'loginToReply': 'Bitte melde dich an, um zu antworten.',
        'loginToCreate': 'Bitte melde dich an, um ein Thema zu erstellen.',
        'threadLocked': 'Dieses Thema ist gesperrt. Es können keine neuen Antworten gepostet werden.',
        'forumLocked': 'Dieses Forum ist gesperrt.',
        'titleRequired': 'Titel ist erforderlich',
        'bodyRequired': 'Inhalt ist erforderlich',
        'noResults': 'Keine Ergebnisse gefunden',
        'backToForum': 'Zurück zum Forum',
        'backToThreads': 'Zurück zu den Themen',
        'subscribe': 'Abonnieren',
    ...
    'account': {
        'legacyClaim': {
            ...
            'intro': 'Wiki-Seiten, Events und Galerien wurden von der alten Seite importiert und kennen noch ihre ursprünglichen Besitzer. Gib deinen alten Benutzernamen oder deine damalige E-Mail ein, um zu prüfen, was dir gehört, und die Übertragung anzufragen — ein Admin prüft und weist die Inhalte diesem Konto zu.',
            'identityLabel': 'Dein Benutzername oder deine E-Mail auf der alten Seite',
            'identityHint': 'Beides geht — eine E-Mail wird in der importierten Mitgliederliste gesucht',
            'check': 'Prüfen',
            ...
            'resolvedFromEmail': 'Gefunden über die E-Mail {email}',
            'emailUnknown': 'Kein altes Konto mit der E-Mail „{email}" bekannt. Versuche es mit deinem alten Benutzernamen.',
            'idLabel': 'Alte Mitglieds-ID (optional)',
            'idHint': 'z. B. deine Forum-ID, falls bekannt',
